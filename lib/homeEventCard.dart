      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      EventInfo(event_map: widget.event_data, data: widget.data)));
        },
        child: Column(
          children: [
            Container(
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(widget.event_data.url), fit: BoxFit.fill),
            ...
            Container(
              child: Padding(
                padding: EdgeInsets.only(left: 10.0,top: MediaQuery.of(context).size.height * 0.02),
                child: Column(
                    ...
                    Row(
                      children: [
                        Text(
                          ...
                          style: TextStyle(color: Color(0xFFFF7F11),fontSize: 17.0,),
                        ),
                        Spacer(),
                        IconButton(
                          iconSize: 30.0,
