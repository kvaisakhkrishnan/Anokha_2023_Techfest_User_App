...
class PassportBuy extends StatefulWidget {
  const PassportBuy({Key? key}) : super(key: key);
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: Text("Passport - Your Visa into Anokha",
            style: TextStyle(
          ...
          Padding(
            padding: EdgeInsets.only(top : MediaQuery.of(context).size.height * 0.03, bottom:MediaQuery.of(context).size.height * 0.03, left: MediaQuery.of(context).size.width * 0.27, right: MediaQuery.of(context).size.width * 0.27),
